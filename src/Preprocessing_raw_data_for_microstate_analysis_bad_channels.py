...
#data_residue = raw_residue.get_data()
#data_residue = np.resize(data_residue,(69, 10800))
#
...
#maps_residue, segmentation_residue = microstates.segment(data_residue, n_states= n_states_residue, n_inits = n_inits_residue)
